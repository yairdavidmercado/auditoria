...
@Component({
  selector: 'app-lista-pendiente',
  templateUrl: './lista-pendiente.component.html',
  styleUrls: ['./lista-pendiente.component.css']
})
export class ListaPendienteComponent implements OnInit {
